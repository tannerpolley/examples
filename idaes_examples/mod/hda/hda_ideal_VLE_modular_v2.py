...
cp_ig_data = {
    ...
    ("methane", 4): 0,
    ("diphenyl", 0): -9.707e1 / R,
    ("diphenyl", 1): 1.106e0 / R,
    ("diphenyl", 2): -8.855e-4 / R,
    ("diphenyl", 3): 2.790e-7 / R,
    ("diphenyl", 4): 0,
}
...
thermo_config = {
    ...
    "components": {
        ...
        "diphenyl": {
            "type": Component,
            "elemental_composition": {"C": 12, "H": 10},
            "dens_mol_liq_comp": PerrysSafe,
            "enth_mol_liq_comp": Perrys,
            "enth_mol_ig_comp": RPP5,
            "pressure_sat_comp": RPP5,
            "phase_equilibrium_form": {("Vap", "Liq"): fugacity},
            "parameter_data": {
                "mw": (154.212e-3, pyunits.kg / pyunits.mol),  # [1]
                "pressure_crit": (38.5e5, pyunits.Pa),  # [1]
                "temperature_crit": (789.0, pyunits.K),  # [1]
                "dens_mol_liq_comp_coeff": {
                    "eqn_type": 1,
                    "1": (1.0162, pyunits.kmol * pyunits.m ** -3),  # [2] pg. 2-98
                    "2": (0.2655, None),
                ...
                "enth_mol_form_vap_comp_ref": (82.9e3, pyunits.J / pyunits.mol),  # [3]
                "pressure_sat_comp_coeff": {
                    "A": (4.18870, pyunits.dimensionless),  # [4]
                    "B": (1841.480, pyunits.K),
                    "C": (185.150, pyunits.K),
                },
            },
        },
